...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Hint:user name,password = admin");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventorymanagementsystem/urban-landscape-with-high-skyscrapers-vehicles_78072-554.jpg"))); // NOI18N
    ...
    // Define dummy credentials (you can later connect this to a database)
    ...
    if (username.equals(correctUsername) && password.equals(correctPassword)) {
        ...
        // Proceed to the next page or functionality (e.g., opening a new JFrame)
        this.dispose(); // Close the login window
        new Items().setVisible(true); // Assuming you have another frame named 'InventoryDashboard'
    } else {
